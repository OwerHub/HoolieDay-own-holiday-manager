...
function Login() {
  const urlScopeCalendar = `https://accounts.google.com/o/oauth2/v2/auth?response_type=code&client_id=856443790783-ur90d5sq8jvuouqjabb91npiide0k9p9.apps.googleusercontent.com&scope=https://www.googleapis.com/auth/calendar&redirect_uri=http%3A//localhost:3000`;
  ...
  const loginAuth = () => {
    ...
    window.location.href = urlScopeWithoutCalendar;
  };
